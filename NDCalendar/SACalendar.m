     ...
     pagingEnabled:(BOOL)paging
{
    ...
    if (self) {
        ...
        dayLabels = [[NSArray alloc]initWithObjects:@"Sun",@"Mon",@"Tue",@"Wed",@"Thu",@"Fri",@"Sat",nil];
...
- (NSInteger)collectionView:(UICollectionView *)collectionView numberOfItemsInSection:(NSInteger)section
{
    ...
    firstDay = (int)[daysInWeeks indexOfObject:[DateUtil getDayOfDate:1 month:monthToLoad year:yearToLoad]] + 7;
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if(indexPath.row<7){
        cell.circleView.hidden = cell.selectedView.hidden = YES;

        cell.dateLabel.text = [dayLabels objectAtIndex:indexPath.row];
        return cell;
    }
